Feature: Bookcategory
  ...
  Background: I should be able to see home
  ...
  Scenario Outline: I should be able to book page with filters
    When  I select book cateogry from top menu tabs on home page
  ...
  Scenario Outline:  I should be able to choose any filter option with specific result
    ...
    Examples:
      ...
      | Sort by | Name: Z to A      | sorted prodcut with the product name in alphabetical order Z to A |
      ...
      | Sort by | Created on        | Recently added prodcut should be show first                       |
  ...
  Scenario Outline: I should be able to see product display format according to display format type as per given picture in srs document
    ...
    Then  I should be able to to see product display format according to display format type as per given picture in SRS document
    Examples:
      | display format icon |
      | Grid                |
      | List                |